...
<div class="card-deck">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <p class="card-text">At the end of the day we'll ring out CrossingsCon 2025 with closing ceremonies, and we'll finish with our post-con party (a.k.a. dead dog) somewhere nearby.</p>
    </div>
  </div>
</div>
